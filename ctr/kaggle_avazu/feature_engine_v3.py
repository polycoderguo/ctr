...
if __name__ == "__main__":
    ...
    convert_feature(utility.get_date_file_path("v.csv"), utility.get_date_file_path("test_features_v3.csv"),
                    utility.get_date_file_path("feature_map_v3.json"), shared_app_map_file=utility.get_date_file_path("app_feature_map_v3.json"), shared_site_map_file=utility.get_date_file_path("site_feature_map_v3.json"))