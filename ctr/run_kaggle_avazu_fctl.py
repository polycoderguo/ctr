...
if __name__ == "__main__":
    ...
    model_file = "app_model_fctl_v3_{0}_{1}_{2}_{3}.json".format(alpha, beta, lambda1, lambda2)
    readable_model_file = "app_model_fctl_v3_{0}_{1}_{2}_{3}_readable.json".format(alpha, beta, lambda1, lambda2)
    print "training......"
    ...
    for i in xrange(iter):
        ...
        alg.train(train_fs, alpha, beta, lambda1, lambda2, report_interval=-1)
